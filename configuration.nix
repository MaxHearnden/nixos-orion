      ...
      tables.dns-udp = {
        ...
        content = ''
          ...
          chain dns-rd {
            ...
            pkttype host udp dport 53 @th,87,1 == 1 ip saddr @local_ip redirect to :55 comment "Recursion desired"
            pkttype host udp dport 53 @th,87,1 == 1 ip6 saddr @local_ip6 redirect to :55 comment "Recursion desired"
            pkttype host udp dport 53 redirect to :54 comment "Recursion not desired"
          }
        '';
      };
    };
